...
Alternatively, if [docker](https://docs.docker.com/install/) is available, 
the 
[prebuilt DiscoRhythm container](https://hub.docker.com/r/mcarlucci/discorhythm) 
can be pulled from Docker Hub and run locally to avoid installation of 
DiscoRhythm and its dependencies.
