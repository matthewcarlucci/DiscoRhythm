...
#' expected naming format described in the vignette. May also be a 
#' SummarizedExperiment with colData in the same format as Metadata.
...
#'
discoInterCorOutliers <- function(Maindata,
                                  cor_method = "pearson",
                                  threshold = 3,
                                  thresh_type = "SD") {
...
#'
discoRepAnalysis <- function(Maindata,
                             Metadata=NULL,
